...
|---|---|---|---|
| Codex CLI (`root`) | `task.md`; `STATE.md`; `RULES.md`; `spec.md`; `docs Toplink/TOPLINK_PAGE_MASTER_PLAN.md`; `docs Toplink/TOPLINK_PAGE_MILESTONES.md`; `docs/system/toplink-google-sheets-operational-contract.md`; `docs/system/toplink-sheet-dataset-registry.json`; `.trellis/scripts/toplink_sheet_sync.py`; `.trellis/scripts/tests/test_toplink_sheet_sync.py`; `.trellis/tasks/08-04-toplink-sheet-model-correction/**`; `docs Toplink/staging/run1/sheet-model-addendum.json`; `docs Toplink/staging/run2/correction/**` | 2026-08-04T21:20:38+07:00 | Implement and verify the 24-dataset Sheet-model correction; local-only until a new digest-bound approval. |
